  ...
  return (
    <nav role="navigation" aria-label="Social media links">
      ...
      <div className="flex space-x-8 pt-8 transition-all duration-800 ease-in-out">
        ...
        >
          <FaInstagram className="text-xl text-slate-600 dark:text-bluetextdefault hover:text-pink-600 dark:hover:text-pink-400 transition-colors duration-200" />
        </a>
        <a 
          ...
          className="focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-900 rounded-md p-1 -m-1"
        >
          <FaLinkedin className="text-xl text-slate-600 dark:text-bluetextdefault hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200" />
        </a>
        <a 
          ...
          className="focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-900 rounded-md p-1 -m-1"
        >
          <FaGithub className="text-xl text-slate-600 dark:text-bluetextdefault hover:text-gray-800 dark:hover:text-gray-200 transition-colors duration-200" />
        </a>
      </div>
    </nav>
  );
